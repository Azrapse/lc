<?php
// Asegurarse de que el helper Layout está disponible en todos los controladores que hagan uso de él.
// Por ejemplo añadiendo a AppController 	function beforeRender(){$this->helpers[] = 'Layout';}
// Uso en el layout:
// < ? $this->Layout->output($SECCION_for_layout);  ? >
// Uso en la vista:
// < ?=$layout->blockStart('SECCION');? > 
//    contenido HTML
// < ?=$layout->blockEnd();? >
