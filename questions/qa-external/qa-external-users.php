...
*/
	...
	//	Until you edit this function, don't show login, register or logout links
		...
		return array(
			'login' => 'https://legalecloud.com/users/login',
			'register' => 'https://legalecloud.com/users/create_account',
			'logout' => 'https://legalecloud.com/users/logout'
		);
...
*/
	...
	//	Until you edit this function, nobody is ever logged in
		...
		//session_start();		
		$userId = $_COOKIE['CakeCookie']['loggedUserId'];
		$userLogin = $_COOKIE['CakeCookie']['loggedUserLogin'];
		$userName = $_COOKIE['CakeCookie']['loggedUserName'];
